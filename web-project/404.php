						...
						<div class="row">
							<div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-12">
								...
								<div class="error-inner">
									...
									<p>Oops! The page you are looking for does not exist. Quick now! touch the button below to go home.</p><br><br>
									<button onclick="back()"  class="btn btn-warning">HOME PAGE</button>
								</div>
								<!--/ End Error Inner -->
							</div>
						</div>
