...
$content=mysqli_real_escape_string($connection,$_POST["content"]);
    if(!empty($title && $subject && $content )){
        $run ="INSERT into student (title,subject,content,uploaded_on) VALUES ('".$title."','".$subject."','".$content."', NOW())";
            $insert=mysqli_query($connection,$run);
        if($insert){
                $statusMsg = "Information has been successfully posted.";
            }
        
    }

else{
    $statusMsg = 'All fields must be filled.';
}
                ...
                <ul class="list-inline menu-left mb-0">
                    ...
                    <li class="d-none d-sm-block">
                        <div class="dropdown pt-3 d-inline-block"><a class="btn btn-header waves-effect waves-light dropdown-toggle" href="index.html#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Create
                                New</a>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink"><a class="dropdown-item" href="add-new-event.php">Event</a>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-12">
            <div class="page-title-box">
              <h4 class="page-title">ADD student information</h4>
              <ol class="breadcrumb">
        ...
        <div class="page-content-wrapper">
          ...
          <div class="form-group">
              ...
              <input class="form-control" name="title" type="text" id="name" placeholder="Enter name">
          </div>
          <div class="form-group">
              <label for="name">subject</label>
              <input class="form-control" name="subject" type="text" id="name" placeholder="Enter name">
          </div>
          <!-- TEXTAREA -->
          <div class="form-group">
              <label for="message">Content</label>
              <textarea class="form-control" name="content" id="message" rows="11"></textarea>
          </div>
          ...
          <button class="btn btn-primary" id="upload" name="submit" type="submit">post</button>
      </form>
